...
const SPECIALTY_THEMES: Record<string, ChatThemeProperties> = {
  Psicología: {
    "--chat-header": "#3E4145",
    "--chat-accent": "#C6B8C0",
    "--chat-accent-strong": "#64565F",
    "--chat-canvas": "#F5F3F2",
    "--chat-patient": "#E9E3E5",
    "--chat-assistant": "#FCFBFA",
  },
  Nutrición: {
    "--chat-header": "#3B443E",
    "--chat-accent": "#C5D0C0",
    "--chat-accent-strong": "#57675A",
    "--chat-canvas": "#F5F6F2",
    "--chat-patient": "#E8ECE2",
    "--chat-assistant": "#FCFCFA",
  },
  Fisioterapia: {
    "--chat-header": "#3B464C",
    "--chat-accent": "#C2CDD2",
    "--chat-accent-strong": "#586A73",
    "--chat-canvas": "#F4F6F6",
    "--chat-patient": "#E7ECEE",
    "--chat-assistant": "#FCFCFC",
  },
  Dental: {
    "--chat-header": "#4A403B",
    "--chat-accent": "#D4C0B5",
    "--chat-accent-strong": "#795F52",
    "--chat-canvas": "#F6F4F1",
    "--chat-patient": "#ECE4DF",
    "--chat-assistant": "#FCFBF9",
  },
  Medicina: {
    "--chat-header": "#384440",
    "--chat-accent": "#BDCCC8",
    "--chat-accent-strong": "#506A63",
    "--chat-canvas": "#F3F6F4",
    "--chat-patient": "#E4EBE8",
    "--chat-assistant": "#FCFCFB",
  },
};
